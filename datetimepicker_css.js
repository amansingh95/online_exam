...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
	...
	{ //Parse existing Date String
		...
		else if (Cal.Format.toUpperCase() === "DDMMYYYY" || Cal.Format.toUpperCase() === "MddmmYYYY"){
			if (DateSeparator === ""){
		...
		else if (Cal.Format.toUpperCase() === "YYYYddmm" || Cal.Format.toUpperCase() === "YYYYMddmm")
		{
			if (DateSeparator === ""){
		...
		else if (Cal.Format.toUpperCase() === "YYddmm" || Cal.Format.toUpperCase() === "YYMddmm")
		{
			if (DateSeparator === "")
			{
				strMonth = exDateTime.substring(2, 4 + offset);
