...
body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #f90 }
  ...
  <form id="login_form" method="post">
    ...
    <table width="466" height="65"  align="left"border="0">
      <tr>
        <td width="383"><?php
						  include("admin_connection.php");
	                      session_start();
						   $check=$_SESSION['new_email'];
						...
						if(isset($_REQUEST['ans_button']))
						{
							if(  $_SESSION['ans']==$_REQUEST['pass_ans'])
								{
								/*echo"hhhhhh";*/header("location:new_password.php");
										         }
										        else
										         {
												 echo"wrong answer";
    ...
    <div class="field_container">
      <input name="pass_ans" type="text" align="center" id="pass_ans" placeholder="Enter answer" requred="requred">
    </div>
    
    <div  align="center"class="field_container">
      <input name="ans_button"  type="submit" id="ans_button" value="OK" style="
    border-color: aqua;
    text color: initial;
    ...
    </div><div id="chrome_web_store" style="opacity: 1;"><span id="chrome_logo"></span>
<h2>&nbsp;</h2>
</div>
