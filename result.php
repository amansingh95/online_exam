...
<table width="1241" height="116" border="0" align="center">
  <tr>
    <td height="112" colspan="2" align="center" bgcolor="#FFFFCC"><span class="style6">WELCOME TO ONLINE EXAM </span></td>
  </tr>
  <tr>
   
    <td height="49" align="right"  bgcolor="#591434"><div align="center" ><a class="style6 style9"style="text-decoration:none; font-weight: bold;">RESULT</a></div>      <div align="center"></div></td>
...
$result=mysql_query($sql);	*/
  ...
  <tr>
    <td height="85" align="center" colspan="2" ><input name="print" type="submit" id="print" value="View Print"/>
	<?php
...
$sql15="insert into  stud_mark(enroll_no ,student_name ,image ,exam_name ,suject_name, mark ,passing ,mark_obtained, percentage,id,e_id)
   values('".$_SESSION['std']."',
   '".$student_name."',
   '".$image."',
   '".$exam_name."',
