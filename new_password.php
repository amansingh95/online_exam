...
body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #f90 }
  ...
  <form id="login_form" method="post">
    <div class="field_container">
      <input name="new_pass" type="password" id="new_pass" requred="requred" placeholder="Enter New Password">
      </br>
	  <input name="new_repass" type="password" id="new_repass" requred="requred" placeholder="Re Enter Password">
    </div>
    
    <div class="field_container">
      <input name="ok"  type="submit" id="ok" value="OK" style="
    border-color: aqua;
    text color: initial;
    ...
    border-bottom-style: outset;>
						...
						if($_REQUEST['new_pass']==$_REQUEST['new_repass'])
						{
...
</form> <div id="chrome_web_store" style="opacity: 1;"><span id="chrome_logo"></span>
<h2>&nbsp;</h2>
</div>
