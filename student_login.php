...
.style4 {
  ...
  <form id="login_form" method="post">
    <div class="field_container">
      <input type="text" name="student_email" placeholder="Email Address">
    </div>
    
    <div class="field_container">
      <input type="Password" name="student_password" placeholder="Password">
	  </br>  </br><input type="submit" name="student_login" value="Login" style="
    border-color: aqua;
	 font-size: larger;
    text color: initial;
...
">
    ...
    <div id="sign_in_options" class="field_container">
		...
		<a href="php-captcha-form-demo.php" class="style4" id="chrome_ad_link" style="text-decoration:none;
    font-size: large;">Sign In</a> 
...
{
$a=$_REQUEST['student_email'];
$b=$_REQUEST['student_password'];
echo $error="Invalid Student User Name and Password";
...
?>
  ...
  <div id="chrome_web_store" style="opacity: 1;margin: -90px 14px 0px -313px;"><span id="chrome_logo"></span>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<a href="email.php" class="style5" id="chrome_ad_link" style="
    font-size: large;">Forgot Password? </a >&nbsp; &nbsp;&nbsp; &nbsp;<a href="change_pass.php" class="login_link" style="
    font-size: large;"> Change Password</a></div>
