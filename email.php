...
body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #f90 }
  ...
  <form id="login_form" method="post">
    <div class="field_container">
      <input name="forgot_email" type="text" id="forgot_email" placeholder="Email Address">
    </div>
    
    <div class="field_container">
      <p>
	  <input name="email_button"  type="submit" id="email_button" value="Login" style="
    border-color: aqua;
    text color: initial;
...
">
    ...
    <div id="sign_in_options" class="field_container">
      <div class="clearfix"></div>
						...
						{
						echo $error="please enter correct email address";
